...
function ProductCard(product) {
  ...
  const handleAddCart = useCallback(async () => {
    ...
    const wishlist = product.onWishlistPage
        ? cx("btn-trash")
        : cx("btn-trash-2");
    ...
    return (
        <div className={cx("wrapper", isRow)}>
            <div className={cx("image")}>
                ...
                {product.discount > 0 ? <CountdownTimer inCard /> : ""}
            ...
            {product.row ? (
                <div className={cx("content")}>
                    ...
                    <div className="flex justify-center gap-2">
                    {
                        ...
                        <div className={cx("price")}>
                            <NumericFormat
                                ...
                                renderText={(value, props) => (
                                    <span {...props} className={cx("price-on-sale")}>{value}</span>
                                )}
                            ></NumericFormat>
                            <NumericFormat
                                thousandSeparator=","
                        ...
                        {product.preOrder ? (
                            <div className="text-green-color">
                                ( Pre-Order ){" "}
                            </div>
                        ) : null}
                    </div>
