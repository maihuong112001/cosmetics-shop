    ...
    <footer className="bg-gray-100 w-full mt-10">
      <div className="w-full mx-auto pb-8 pt-16">
        <div className="md:flex md:mt-0 md:order-1">
          <div className="mt-8 md:mt-0 md:ml-6 px-8 text-[11px] tracking-wider font-base">
            <h2>CONTACT US</h2>
            <br />
          ...
          <div className="mt-8 md:mt-0 md:ml-6 px-32 text-[11px] tracking-wider font-base">
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <p className="text-[11px] tracking-wider font-base ml-10 text-gray-400">
